    ...
    assertThatThrownBy(
            () ->
                service.validateForPersistence(
                    userId,
                    new com.alveryn.api.worktype.entity.WorkType(
                        new com.alveryn.api.user.entity.UserAccount("test@example.com", "hash"),
                        "Rooms",
                        com.alveryn.api.worktype.entity.CalculationMethod.TIME_BASED),
                    request))
