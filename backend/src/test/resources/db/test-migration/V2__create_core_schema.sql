...
-- H2-friendly test copy of the production migration.
-- =========================================================
...
CREATE TABLE user_accounts (
                               ...
                               security_code_expires_at TIMESTAMP WITH TIME ZONE,
...
CREATE TABLE absences (
                          ...
                          CONSTRAINT ck_absences_type
                              CHECK (absence_type IN ('SICK_LEAVE', 'VACATION', 'DAY_OFF', 'UNPAID_LEAVE')),
