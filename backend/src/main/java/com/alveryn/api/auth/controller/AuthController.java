package com.alveryn.api.auth.controller;
...
import com.alveryn.api.auth.service.GoogleOAuthService;
import com.alveryn.api.auth.service.RefreshTokenCookieService;
...
public class AuthController {
  private static final String GOOGLE_STATE_COOKIE = "alveryn_google_oauth_state";
  ...
  public ApiResponse<AuthResponse> verifyEmail(
    ...
    IssuedAuthSession session = authService.verifyEmail(request);
