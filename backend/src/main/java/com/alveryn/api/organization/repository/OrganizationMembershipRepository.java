...
public interface OrganizationMembershipRepository extends JpaRepository<OrganizationMembership, UUID> {
  ...
  List<OrganizationMembership> findAllByUserIdAndStatusOrderByJoinedAtAsc(UUID userId,
      com.alveryn.api.organization.entity.MembershipStatus status);
  List<OrganizationMembership> findAllByOrganizationIdOrderByJoinedAtAsc(UUID organizationId);
}
