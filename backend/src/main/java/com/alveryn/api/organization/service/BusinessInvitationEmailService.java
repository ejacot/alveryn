...
public class BusinessInvitationEmailService {
 ...
 public void send(String email,String organization,String language,boolean existingAccount,String token){
  if(mailFrom==null||mailFrom.isBlank()){log.info("Business invitation suppressed because mail sender is not configured");return;}
  var c=copy(language,existingAccount);String link=baseUrl+"/business-invitation/"+java.net.URLEncoder.encode(token,java.nio.charset.StandardCharsets.UTF_8);
