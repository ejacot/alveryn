...
import com.alveryn.api.staffing.service.StaffingPublishedScheduleService;
...
public class PersonalBusinessScheduleController {
  ...
  @GetMapping public ApiResponse<List<PersonalScheduleResponse>> schedule(@RequestParam LocalDate from,@RequestParam LocalDate to){return ApiResponse.of(publishedSchedule.schedule(from,to));}
