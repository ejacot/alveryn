...
import com.roomly.api.workentry.dto.UnitEntryItemRequest;
...
public class WorkEntryCalculationService {
  ...
  public void persistDetails(
      com.roomly.api.workentry.repository.TimeEntryDetailsRepository timeEntryDetails,
      com.roomly.api.workentry.repository.UnitEntryItemRepository unitEntryItems,
      WorkEntry entry,
  ...
  private UnitType findUnitType(UUID userId, UUID unitTypeId) {
    return unitTypes
        ...
        .orElseThrow(() -> new com.roomly.api.common.exception.NotFoundException("UnitType", unitTypeId));
  }
