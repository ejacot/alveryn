    ...
    <div className="space-y-6 pb-10 pt-4">
      ...
      <SettingsSection title={t("helpPage.support")}>
        <div className="text-center text-sm leading-6 text-white/58">
          <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-[20px] border border-[#10b981]/20 bg-[#10b981]/[0.08] text-[#10b981]"><MessageCircle className="h-6 w-6" /></div>
