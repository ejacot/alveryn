...
import type { WorkRecord, WorkRecordLine, WorkRecordRequest } from "../types/work-record";
...
export function DashboardPage({ selectedDate: selectedDateProp }: DashboardPageProps = {}) {
  ...
  const weeklyPaidAbsences = useMemo(
    ...
    [hourlyRates, preferences, weekEndKey, weekStartKey, weeklyAbsences, weeklyDailyRecords]
  );
