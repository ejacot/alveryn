    ...
    <div className="space-y-6 pb-10 pt-4">
      ...
      <SettingsSection title={t("aboutPage.product")}>
        <div className="text-center text-sm leading-6 text-white/58">
          <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-[20px] border border-[#d5be8d]/20 bg-[#d5be8d]/[0.08] text-[#d5be8d]"><Sparkles className="h-6 w-6" /></div>
      ...
      <SettingsSection title={t("aboutPage.privacy")}>
        <div className="text-sm leading-6 text-white/58">
          <div className="mb-3 flex items-center gap-3 text-white"><Fingerprint className="h-5 w-5 text-[#d5be8d]" /><span>{t("aboutPage.privacyTitle")}</span></div>
