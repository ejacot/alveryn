    ...
    >
      ...
      {items.map(({ to, icon: Icon, label, prominent }) => (
        <NavLink
          ...
          to={to}
          aria-label={label}
          className="desktop-nav-link relative flex min-w-0 flex-1 justify-center"
        >
          {({ isActive }) => (
            <motion.div
              animate={{
              ...
              className={cn(
                "desktop-nav-item flex items-center justify-center transition",
                prominent
            ...
            >
              <Icon
                ...
                aria-hidden="true"
              />
              <span className="desktop-nav-label hidden">{label}</span>
            </motion.div>
          )}
        </NavLink>
      ))}
